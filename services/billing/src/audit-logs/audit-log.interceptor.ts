 ...
 * duplicated per-service throughout this repo (`services/emr`'s BAC-10
 * copy took the identical approach). This is this ticket's documented
 * answer to CLAUDE.md's "reuse the existing audit-log mechanism from BAC-8"
 ...
 * tenant-context types) is service-local, because BAC-8 was never built as
 * a cross-service-importable package.
 *
