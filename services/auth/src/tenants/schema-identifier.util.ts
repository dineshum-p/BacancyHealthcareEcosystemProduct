 ...
 * this service goes through (mirrors `services/tenant`'s guard -- this
 * exact class of bug was a BAC-3/BAC-4 review finding, so `services/auth`
 * gets its own copy of the same guard rather than trusting the value).
 */
