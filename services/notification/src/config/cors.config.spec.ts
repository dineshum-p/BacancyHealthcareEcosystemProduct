...
describe('getCorsConfig', () => {
  ...
  it('reads a comma-separated allow-list from CORS_ALLOWED_ORIGINS', () => {
    process.env.CORS_ALLOWED_ORIGINS =
      'https://notifications.example.com, https://admin.example.com';
  ...
  it('always allows the methods and headers the browser-facing routes actually use', () => {
    process.env.CORS_ALLOWED_ORIGINS = 'https://notifications.example.com';
