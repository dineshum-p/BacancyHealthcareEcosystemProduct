 ...
 * done in production before `services/notification` ever sees the tenant.
 * `services/notification` itself never creates schemas (only its own
 * `notifications` table inside an existing one -- see
