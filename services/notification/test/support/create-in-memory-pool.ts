 ...
 *
 * Mirrors `services/tenant`'s and `services/auth`'s
 * `test/support/create-in-memory-pool.ts`. Own copy because
 * `services/notification` is an independently deployable app and does not
 * import TypeScript from either.
 *
