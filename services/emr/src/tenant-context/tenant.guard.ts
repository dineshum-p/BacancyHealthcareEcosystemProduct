 ...
 * exactly, including its 404 (unknown)/403 (inactive) split -- same
 * convention `services/notification` (BAC-9) already reused for its own
 * authenticated, internal-platform routes.
 */
@Injectable()
